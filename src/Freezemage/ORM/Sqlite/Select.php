...
class Select extends ConditionalQuery implements SelectInterface
{
    ...
    {
        return $this->mapper->getProcessor()->quote($this->orderColumn ?? $this->mapper->getPrimaryField()->getName());
    }
    ...
    protected function buildSelect()
    {
        ...
        foreach ($fields as $item) {
            if ($item instanceof Field) {
                ...
                $field = $this->mapper->getField($item);
            }
            if ($field === null) {
            ...
            if ($field !== null) {
                $alias = $field->getMapper() === $this->mapper ? $processor->quote($field->getName()) : $field->getColumnAlias();
    ...
    {
        $tableName = $this->mapper->getProcessor()->quote($this->mapper->getTableName());
